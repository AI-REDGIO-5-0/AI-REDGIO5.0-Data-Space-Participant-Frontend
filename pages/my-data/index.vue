    ...
    <div class="w-full h-full text-gray-700">
        <UCard v-if="!modelsFetchError">
            <div class="flex justify-between flex-1">
                ...
                <div class="ml-2 flex">
                    <UButton icon="i-heroicons-document-plus" size="md" color="primary" variant="solid"
                        to="/my-data/upload" target="_self" :label="$t('addNew')" :trailing="false" />
                </div>
            </div>
